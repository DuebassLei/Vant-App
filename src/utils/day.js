...
//日期时间，中文
export const DATE_TIME_ZH_FMT = 'YYYY年MM月DD日 HH时mm分ss秒'

//日期时间，中文,不包含秒
export const DATE_TIME_MINUTE_ZH_FMT = 'YYYY年MM月DD日 HH时mm分'

//日期时间，中文
export const DATE_ZH_FMT = 'YYYY年MM月DD日'
 ...
 * @param {*} fmt
 */
export function format_zh_CN(date,fmt=DATE_TIME_ZH_FMT ) {
    return new dayjs(date).format(fmt);
}
 ...
 * 获取当前时间段：早上好、中午好、下午好
 * */
export const getHour_zh_CN = (hour = new Date().getHours())=>{
    if(hour < 6){
        return '凌晨好！'
    }
    else if (hour < 9){
